document.addEventListener('DOMContentLoaded', () => {
    ...
    // ----------------------------------------------------
    const WORD_LIST = [ "WHEY","ISOLAT","CASEINE","PROTEINE","NATIVE","PEPTOPRO","MUSCLEWHEGG","CREATINE","CREAPURE","BCAA","GLUTAMINE","CITRULLINE","ARGININE","GLYCINE","TAURINE",
                       "PREWORKOUT","PEPTIDE","COLLAGENE","PEPTAN","ARTIPRO","MARIN","DEXTROSE","PANCAKES","BARRE","MUESLI","GAINER","MUSCLEMASSE","VITAMINE","MINERAUX","OMEGA","MAGNESIUM",
                       "ZINC","FER","ZMB","QUALIC","QUALID","EPAX","NATICOL","ULTIMINE","TRIBULUS","CAFEINE","GUARANA","CURCUMINE","CARNITINE","CARNIPURE","CHOLINE","LACTIUM","DETOX","BIO",
                       "SHAKER","NUTRIMUSCLE","REBORN","POMPE","SQUAT","TRACTION","FENTES","DIPS","CURLS","PRESSE","ROWING","GAINAGE","EXTENSION","FLEXION","TIRAGE","ELEVATION","POULET",
                       "REPETITION","SERIE","CHARGE","INTENSITE","HALTERE","KETTLEBELL","MACHINE","BANCS","TERRE","MILITAIRE","MOLETS","QUADRI","ISCHIOS","PEC","TRICEPS","BICEPS","ABDOS",
                       "TRAPEZES","DORSEAUX","FORCE","ENDURANCE","VOLUME","MASSE","SECHE","PRISE","PERTE","RECUP","SURCHARGE","PROGRESSION","CALORIES","MACROS","MICRO","FIBRES","GYMNASE",
                       "SALLE","TRAINING","DIETE","REPOS","PRISES","CARDIO","PHYSIQUE","PERFORMER","RESISTANCE","GUNDILL","DELAVIER","EXPERT","AUTEUR","LIVRE","DOSSIER","ANALYSE","CONSEIL",
                       "SCIENCES","RECHERCHE","FORMATEUR","ARTICLE","YOUTUBE","CHAINE","SPORT","PRATIQUE","THEORIE","GUIDE","REFERENCE","METHODE","PROGRAMME","EXPERIENCE","KNOWLEDGE","BIOLOGIE",
                       "ALIMENTS","LOUAN","AUBANGE","POSTWORKOUT","ABDUCTEUR","ADDUCTEUR","SOULEVE","DELTOIDE","ISOMETRIE","CONCENTRIQUE","EXCENTRIQUE","PLIOMETRIE","MUSCULAR","FITNESS",
                       "CHRONO","ECHAUFFEMENT","MUSCULE","LIGAMENT","TENDON","ARTICULATION","PERFORMANCE","ENTRAINER","ENTRAINEMENT","GELULE","PROTEINEE","CREATININE","PHOSPHATE","CARBONE",
                       "LIPIDES","GLUCIDES","SANTÉ","EQUILIBRE","CERTIFIE","FLOCONS","CRANBERRY","CACAHUETES","VANILLE","CHOCOLAT","FRAISE","BANANE","AROME","EDULCORANT","BIOTIQUE","ENZYMES",
                       "DIGESTION","ACIDE","FLACON","QUALITE","PURETE","TRACE","DIAGNOSTIC","FORMULE","VEGAN","CERTIF","PROGRES","BOOSTER","ADAPTOGENE","HYDRATER","RECUPERER","COMPLEXE",
                       "SHODEN","ARNOLD","COLEMAN","YATES","ZANE","HANEY","STRONGMAN","BODYBUILDER","FITGIRL","INFLUENCEUR","POWERLIFTING","CULTURISTE","ENTRAINEUR","CHAMPION","MONDIAL",
                       "OLYMPIA","MENTZER",
                       "HIPTHRUST","BENCHPRESS","DEADLIFT","SQUATJUMP","HANDSTAND","FULLBODY","HYPERTROPHIE","SURMENAGE","CRUNCHES","RAMEUR","PULLEY","GRIPPER","PRESSDOWN","KIPPING","MAXLOAD", "LEGPRESS"
                       "OBLIQUES","CARTILAGE","NEURONAL","TENDINEUX","HORMONAL","CORTISOL","MUSCULAIRE", "LIGAMENTAIRE","NEUROMOTEUR",
                       "ASHWAGANDHA","BOSWELLIA","CITICOLINE","HYDROLYSAT","BIOACTIVE","LIPOSOMALE","PROBIOTIQUE","LIPOSOMIQUE","MICROBIOTES","METABOLITE","ANTIOXYDANT","ELECTROLYTE","FERMENTE",
                       "GLUCAGON","INSULINIQUE","VEGETARIEN","OXYGENATION","EXPLOSIVITE","RESILIENCE","STABILITE","INTENSIFIER","SURCOMPENSER","PERIODISATION","STIMULATION","MOBILISATION","REGULATION","SUPERSERIES",
                       "PHYSIOLOGIE","BIOMECANIQUE","ENDOCRINIE","PROTOCOLES","MOLECULAIRE","NEUROSCIENCE","BIOMECHANIQUE","NEUROPLASTIE","HISTAMINE","MICRONUTRITION","MACRONUTRITION","HYPERCALORIE","HYPOCALORIE","HOMEOSTASIE","GLUCOSE",
                       "LABOUREUR", "NUTRITION", "CROSSFIT", "BODYBUILDING", "STRONGMAN", "AUBANGE", "NUTRIELEMENT", "ARTIPRANE"];
